                  ...
                  <div class="content_wrapper">
                     ...
                     <div class="col-12">
                        <div class="section_heading d-flex justify-content-between align-items-center">
                           <div>
                              <h3 class="mb-0 fs-5">Employee Registration</h3>
                           </div>
                           <div class="m-1">
                              ...
                              <div class="col-md-12" id="countrymaster_pills">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="form-group col-md-2 col-sm-6 col-12">
                                       <label for="">Employee ID<span class="star">*</span></label>
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                      <div class="d-flex justify-content-end">
                                                         ...
                                                         <a id="" class="btn btn-sm" href="EmployeeRegistration_form.php">
                                                            <i class="fa-duotone fa-solid fa-pen-to-square fa-lg"
                                                               style="--fa-primary-color: #0d6efd; --fa-secondary-color: #0d6efd;">
                                                            </i>
                                                         </a>
                                                      </div>
                                                   </td>
