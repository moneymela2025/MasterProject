                  ...
                  <div class="loginWrapperOuter">
                     <div class="card">
                        <div class="login-header">
                           <h4 class="fs-4 fw-bolder mb-0">Forgot Password</h4>
                        </div>
                        <div class="col-12">
                           ...
                           <div class="tab-content p-0">
                              <div class="tab-pane fade show active">
                                 ...
                                 <div class="form-group">
                                    <label for="">Your User Id<span class="star">*</span></label>
                                    <input name="pan number" type="text" maxlength="10" id="" class="form-control" placeholder="Enter Your User Id">
                                </div>
                                <div class="form-group">
