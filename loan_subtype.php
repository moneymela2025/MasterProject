                  ...
                  <div class="container-fluid">
                     <div class="row">
                        <div class="col-12">
                            <nav class="breadcrumb mt-2">
                                ...
                                <span class="breadcrumb-item active" aria-current="page">Loan Sub Type</span>
                            </nav>
                        </div>
                     </div>
                     ...
                     <div class="col-12">
                        <div class="section_heading d-flex justify-content-between align-items-center">
                           <div>
                              <h3 class="mb-0 fs-5">Loan Sub Type</h3>
                           </div>
                        </div>
                           ...
                           <div class="row">
                              <div class="col-md-12" id="countrymaster_pills">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-12">
                                          <label for="">Loan Sub type</label>
                                          <input name="Loan Sub type" type="text" maxlength="7" id="" autocomplete="off" placeholder="Loan Sub type" class="form-control">
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-12">
